...
module.exports = function (db){
    ...
    router.post('/add', isLoggedIn, async function (req, res, next) {
        try{
            ...
            await userPicture.mv(uploadPath, function(err) {
                ...
                db.query(addData, [req.body.user_name, req.body.user_phone, req.body.user_idcard, req.body.user_email, hash, req.body.user_address, req.body.user_status, filename], (err, data) => {
                    if (err) {
                        console.log(err);
                        return res.send(err)}
    ...
    router.post('/edituser/:id', isLoggedIn, async function (req, res, next) {
        try{
